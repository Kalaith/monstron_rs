...
- `screens/` – Screen-specific rendering (if separated from main.rs)
  - Owns screen-specific UI, layout rectangles, input mapping, and action enums
  - Keep drawing/input code here or in `ui/`; do not spread it into state, data, or engine modules
...
- Target: 150–350 lines per file
- Soft limit: 400 lines
- Hard limit: 500 lines for every Rust source file
- If a file approaches the hard limit, split by responsibility before adding the next feature.
